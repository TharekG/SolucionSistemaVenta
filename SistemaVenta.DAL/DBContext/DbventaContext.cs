    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetalleVenta>(entity =>
        {
            ...
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK__DetalleVe__idVen__6E01572D");
        });
        ...
        modelBuilder.Entity<Menu>(entity =>
        {
            ...
            entity.HasOne(d => d.IdMenuPadreNavigation).WithMany(p => p.InverseIdMenuPadreNavigation)
                ...
                .HasConstraintName("FK__Menu__idMenuPadr__4AB81AF0");
        });

        modelBuilder.Entity<Negocio>(entity =>
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107B2717C28");
        ...
        modelBuilder.Entity<RolMenu>(entity =>
        {
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                ...
                .HasConstraintName("FK__RolMenu__idMenu__52593CB8");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMenu__idRol__5165187F");
        });
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561459903729");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__693CA210");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdUsuario)
                .HasConstraintName("FK__Venta__idUsuario__6A30C649");
        });
